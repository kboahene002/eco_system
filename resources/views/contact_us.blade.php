                ...
                <div class="container">
                   ...
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav menu ms-auto">
                            ...
                            <li class="nav-item dropdown submenu">
                                <a class="nav-link text-dark " href="/loan" role="button" aria-haspopup="true"
                                    aria-expanded="false">
                                    Loan
                                </a>
                            ...
                            <li class="nav-item dropdown submenu">
                                <a class="nav-link text-dark active" href="/contact" role="button" aria-haspopup="true"
                                    aria-expanded="false">
                                    Contact us
                                </a>
                        ...
                        <div class="row mt-55">
                            ...
                            <div class="col-sm-6">
                                <div class="get-touch-box mt-30">
                                    ...
                                    <div>
                                        <p>Location</p>
                                        <span>Stanbic Height, Accra Ghana</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="faq-body pr-lg-130">
                                                <p>Yes, you can pay off your loan early, and in many cases, this can help you save money on interest. However, it’s important to review your loan agreement, as some loans may include early repayment fees or conditions. We recommend checking the terms of your loan or speaking with one of our representatives to understand any charges that may apply before making an early payment.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="w-100">
                                        <div class="faq-header" id="headingTwo">
                                            <h4 class="mb-0 collapsed" data-bs-toggle="collapse"
                                                ...
                                                How much can I bank?<i class="icon_plus"></i><i
                                                    class=" icon_minus-06"></i>
                                            </h4>
                                        </div>
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body pr-lg-130">
                                                <p>There is no strict limit on how much money you can deposit into your account. However, large deposits may require additional verification in line with banking regulations and anti-money laundering policies. For daily deposits at ATMs or teller windows, limits may apply depending on your account type. Please contact us for details specific to your account.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="single-widget-one wow fadeInUp px-sm-5 px-4" data-wow-delay="0.5s">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body pr-lg-130">
                                                <p>Yes, we offer refinancing options to help you better manage your loan. Refinancing allows you to replace your existing loan with a new one—often with improved terms such as lower interest rates, reduced monthly payments, or a shorter repayment period. Our team will work with you to review your current loan and financial goals, so you can choose the refinancing option that best suits your needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-widget-one wow fadeInUp px-sm-5 px-4" data-wow-delay="0.7s">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body pr-lg-130">
                                                <p>Yes, you can manage all of your banking needs with us. We provide a full range of services, including savings and checking accounts, loans, credit facilities, online and mobile banking, as well as investment options. Whether you need everyday banking, long-term savings, or financial support, our comprehensive solutions are designed to make banking simple, secure, and convenient in one place.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-widget-one wow fadeInUp px-sm-5 px-4" data-wow-delay="0.9s">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body pr-lg-130">
                                                <p>It’s best to apply as early as possible to give yourself enough time to prepare all required documents and complete the process without stress. Early applications also increase your chances of faster approval and help you secure the best options available. However, you can apply at any time that suits your financial needs, and our team will guide you through each step..</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-7">
                                    <div class="cta-content wow fadeInRight text-center text-lg-start">
                                        <h2 class="mb-0">Meet ecobank, the financial partner you can bank on.</h2>
                                    </div>
                                </div>
