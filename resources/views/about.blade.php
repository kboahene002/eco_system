...
<body>
                ...
                <div class="container">
                   ...
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav menu ms-auto">
                            ...
                            <li class="nav-item dropdown submenu">
                                <a class="nav-link text-dark active" href="/about" role="button" aria-haspopup="true"
                                    aria-expanded="false">
                                    About
                                </a>
    ...
    <main>
        <!-- Banner start -->
        <section class=" pt-145" style="background-image: url('{{ asset('img/banner/about-bg.png') }}');">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="desc-text pl-lg-10">
                                <p>Ecobank Bank’s journey started with a single belief to connect people,
                                    places and
                                    possibilities by doing things others said could not be done. Anchored on this
                                    belief,
                                    the Bank was founded in 2017 and we are, to date, headquartered in the Ghana
                                    International Financial Centre with a representative office in United States.</p>
                                <p class="mt-20">Ecobank Bank's core banking and transactional capabilities are also
                                    complemented. Ecobank
                        ...
                        <div class="col-lg-4 col-7">
                            <div class="tab-content wow fadeInUp" data-wow-delay="0.3s" id="myTabContent">
                                <div class="tab-pane fade show active" id="twenty" role="tabpanel"
                                    ...
                                    <h3>2020</h3>
                                    <p>The First Ghanaian Bank to join the GRI Community</p>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="cta-content text-black wow fadeInRight">
                            <h2>Our latest financial mobile app</h2>
                            <p>Experience banking like never before with our new mobile app — designed to bring speed, security, and simplicity to your financial journey. From managing accounts and tracking transactions to making seamless payments and accessing personalized financial insights, everything you need is now right at your fingertips. Stay in control, anytime, anywhere, with a secure and user-friendly interface built to make your banking experience smarter and more convenient.</p>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="cta-content mt-3 mt-sm-0 text-sm-end text-center">
                            <a href="/mobile" class="theme-btn wow fadeInLeft">See results</a>
                        </div>
                    </div>
                </div>
            </div>
